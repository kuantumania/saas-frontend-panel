  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        data-side={side}
        className={cn(
          "fixed z-50 flex flex-col gap-4 bg-background bg-clip-padding text-sm shadow-lg",
          ...
          "data-[side=bottom]:border-t data-[side=bottom]:data-ending-style:translate-y-[2.5rem]",
          ...
          "data-[side=top]:border-b data-[side=top]:data-ending-style:translate-y-[-2.5rem]",
