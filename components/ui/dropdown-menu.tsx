      ...
      >
        <MenuPrimitive.Popup
          ...
          className={cn(
            ...
            "data-open:zoom-in-95 data-closed:animate-out data-closed:overflow-hidden",
  ...
  return (
    <DropdownMenuContent
      ...
      className={cn(
        ...
        "shadow-lg ring-1 ring-foreground/10 duration-100 data-[side=bottom]:slide-in-from-top-2",
        "data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2",
        "data-[side=top]:slide-in-from-bottom-2 data-open:animate-in data-open:fade-in-0",
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <MenuPrimitive.CheckboxItem
      ...
      data-inset={inset}
      className={cn(
        "relative flex cursor-default items-center gap-1.5 rounded-md py-1 pr-8 pl-1.5",
        "text-sm outline-hidden select-none focus:bg-accent focus:text-accent-foreground",
        "focus:**:text-accent-foreground data-inset:pl-7",
        "data-disabled:pointer-events-none data-disabled:opacity-50",
        "[&_svg]:pointer-events-none [&_svg]:shrink-0",
        "[&_svg:not([class*='size-'])]:size-4",
        className
