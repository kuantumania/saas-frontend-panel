    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          ...
          "-translate-x-1/2 -translate-y-1/2 gap-4 rounded-xl bg-background p-4",
          "text-sm ring-1 ring-foreground/10 duration-100 outline-none sm:max-w-sm",
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn(
        "text-sm text-muted-foreground *:[a]:underline",
